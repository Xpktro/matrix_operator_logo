...
var paper = function (self, undefined) {
	...
	var Point = Base.extend({
		...
		initialize: function Point(arg0, arg1) {
			var type = typeof arg0 === 'undefined' ? 'undefined' : _typeof(arg0),
			    reading = this.__read,
			    read = 0;
			if (type === 'number') {
	...
	var Item = Base.extend(Emitter, {
		...
		statics: {
			_getItems: function _getItems(item, options, matrix, param, firstOnly) {
				if (!param) {
					var obj = (typeof options === 'undefined' ? 'undefined' : _typeof(options)) === 'object' && options,
		...
		transform: function (matrix, _applyMatrix, _applyRecursively, _setApplyMatrix) {
			var _matrix = this._matrix,
			    ...
			    applyMatrix = (_applyMatrix || this._applyMatrix) && (!_matrix.isIdentity() || transform || _applyMatrix && _applyRecursively && this._children);
			if (!transform && !applyMatrix) return this;
			if (transform) {
	...
	var Segment = Base.extend({
		...
		initialize: function Segment(arg0, arg1, arg2, arg3, arg4, arg5) {
			var count = arguments.length,
			    ...
			    selection;
			if (count > 0) {
				if (arg0 == null || (typeof arg0 === 'undefined' ? 'undefined' : _typeof(arg0)) === 'object') {
			...
			for (var i = 0; i < offsets.length && winding.quality < 0.5; i++) {
				...
				for (var j = 0, l = chain.length; j < l; j++) {
					...
					if (length <= curveLength) {
						...
						var wind = !(operator.subtract && path2 && (operand === path1 && path2._getWinding(pt, dir, true).winding || operand === path2 && !path1._getWinding(pt, dir, true).winding)) ? getWinding(pt, curves, dir, true) : { winding: 0, quality: 1 };
	...
	var Color = Base.extend(new function () {
		...
		return Base.each(types, function (properties, type) {
			...
			initialize: function Color(arg) {
				...
				var argType = arg != null && (typeof arg === 'undefined' ? 'undefined' : _typeof(arg));
	...
	var GradientStop = Base.extend({
		...
		initialize: function GradientStop(arg0, arg1) {
			var color = arg0,
			    offset = arg1;
			if ((typeof arg0 === 'undefined' ? 'undefined' : _typeof(arg0)) === 'object' && arg1 === undefined) {
		...
		Project.inject({
			exportSVG: function (options) {
				...
				var children = this._children,
				    ...
				    rect = bounds === 'view' ? new Rectangle([0, 0], view.getViewSize()) : bounds === 'content' ? Item._getBounds(children, matrix, { stroke: true }).rect : Rectangle.read([bounds], 0, { readNull: true }),
				    attrs = {
					version: '1.1',
	...
	new function () {
		...
		function importSVG(source, options, owner) {
			...
			function onLoad(svg) {
				try {
					var node = (typeof svg === 'undefined' ? 'undefined' : _typeof(svg)) === 'object' ? svg : new self.DOMParser().parseFromString(svg, 'image/svg+xml');
					if (!node.nodeName) {
						node = null;
	...
	Base.exports.PaperScript = function () {
							...
							if (octal) {
								...
								switch (ch) {
									...
									case 114:
										out += "\r";break;
									case 120:
										out += String.fromCharCode(readHexChar(2));break;
									case 117:
										out += String.fromCharCode(readHexChar(4));break;
									case 85:
										out += String.fromCharCode(readHexChar(8));break;
									case 116:
										out += "\t";break;
									case 98:
										out += "\b";break;
		...
		function execute(code, scope, options) {
			...
			var view = scope.getView(),
			    ...
			    args = [],
			    func,
			    compiled = (typeof code === 'undefined' ? 'undefined' : _typeof(code)) === 'object' ? code : compile(code, options);
			code = compiled.code;
...
},{"./node/self.js":"../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/_empty.js","./node/extend.js":"../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/_empty.js","process":"../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/roughjs/bin/path.js":[function(require,module,exports) {
'use strict';
...
exports.RoughPath = RoughPath; // Algorithm as described in https://www.w3.org/TR/SVG/implnote.html
...
},{}],"node_modules/roughjs/bin/geometry.js":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/roughjs/bin/utils/hachure.js":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.HachureIterator = undefined;
...
class HachureIterator {
    constructor(top, bottom, left, right, gap, sinAngle, cosAngle, tanAngle) {
        ...
        if (Math.abs(sinAngle) < 0.0001) {
            ...
            this.sLeft = new _geometry.Segment([left, bottom], [left, top]);
            this.sRight = new _geometry.Segment([right, bottom], [right, top]);
        }
    }
    nextLine() {
        if (Math.abs(this.sinAngle) < 0.0001) {
            ...
            if (this.pos < this.right + this.deltaX) {
                ...
                const s = new _geometry.Segment([xLower, yLower], [xUpper, yUpper]);
...
},{"../geometry":"node_modules/roughjs/bin/geometry.js"}],"node_modules/roughjs/bin/fillers/filler-utils.js":[function(require,module,exports) {
'use strict';
...
var _hachure = require('../utils/hachure');
...
function getIntersectingLines(line, points) {
    const intersections = [];
    const s1 = new _geometry.Segment([line[0], line[1]], [line[2], line[3]]);
    for (let i = 0; i < points.length; i++) {
        const s2 = new _geometry.Segment(points[i], points[(i + 1) % points.length]);
        if (s1.intersects(s2)) {
...
function hachureLinesForPolygon(points, o) {
    ...
    if (points && points.length) {
        ...
        const it = new _hachure.HachureIterator(top - 1, bottom + 1, left - 1, right + 1, gap, sinAngle, cosAngle, tanAngle);
        let rect;
...
},{"../geometry":"node_modules/roughjs/bin/geometry.js","../utils/hachure":"node_modules/roughjs/bin/utils/hachure.js"}],"node_modules/roughjs/bin/fillers/hachure-filler.js":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.HachureFiller = undefined;

var _fillerUtils = require('./filler-utils');
...
class HachureFiller {
    ...
    _fillPolygon(points, o, connectEnds = false) {
        const lines = (0, _fillerUtils.hachureLinesForPolygon)(points, o);
        const ops = this.renderLines(lines, o, connectEnds);
        return { type: 'fillSketch', ops };
    }
    _fillEllipse(cx, cy, width, height, o, connectEnds = false) {
        const lines = (0, _fillerUtils.hachureLinesForEllipse)(cx, cy, width, height, o, this.renderer);
        const ops = this.renderLines(lines, o, connectEnds);
        return { type: 'fillSketch', ops };
    }
...
},{"./filler-utils":"node_modules/roughjs/bin/fillers/filler-utils.js"}],"node_modules/roughjs/bin/fillers/zigzag-filler.js":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.ZigZagFiller = undefined;

var _hachureFiller = require('./hachure-filler');

class ZigZagFiller extends _hachureFiller.HachureFiller {
    fillPolygon(points, o) {
...
},{"./hachure-filler":"node_modules/roughjs/bin/fillers/hachure-filler.js"}],"node_modules/roughjs/bin/fillers/hatch-filler.js":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.HatchFiller = undefined;

var _hachureFiller = require('./hachure-filler');

class HatchFiller extends _hachureFiller.HachureFiller {
    fillPolygon(points, o) {
...
},{"./hachure-filler":"node_modules/roughjs/bin/fillers/hachure-filler.js"}],"node_modules/roughjs/bin/fillers/dot-filler.js":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.DotFiller = undefined;
...
class DotFiller {
    ...
    dotsOnLines(lines, o) {
        ...
        for (const line of lines) {
            const length = (0, _fillerUtils.lineLength)(line);
            const dl = length / gap;
...
},{"./filler-utils":"node_modules/roughjs/bin/fillers/filler-utils.js"}],"node_modules/roughjs/bin/fillers/filler.js":[function(require,module,exports) {
'use strict';
...
var _zigzagFiller = require('./zigzag-filler');

var _hatchFiller = require('./hatch-filler');

var _dotFiller = require('./dot-filler');
...
function getFiller(renderer, o) {
    ...
    if (!fillers[fillerName]) {
        switch (fillerName) {
            case 'zigzag':
                if (!fillers[fillerName]) {
                    fillers[fillerName] = new _zigzagFiller.ZigZagFiller(renderer);
                }
                break;
            case 'cross-hatch':
                if (!fillers[fillerName]) {
                    fillers[fillerName] = new _hatchFiller.HatchFiller(renderer);
                }
                break;
            case 'dots':
                if (!fillers[fillerName]) {
                    fillers[fillerName] = new _dotFiller.DotFiller(renderer);
                }
                break;
            case 'hachure':
            default:
                fillerName = 'hachure';
                if (!fillers[fillerName]) {
                    fillers[fillerName] = new _hachureFiller.HachureFiller(renderer);
                }
                break;
        }
    }
...
},{"./hachure-filler":"node_modules/roughjs/bin/fillers/hachure-filler.js","./zigzag-filler":"node_modules/roughjs/bin/fillers/zigzag-filler.js","./hatch-filler":"node_modules/roughjs/bin/fillers/hatch-filler.js","./dot-filler":"node_modules/roughjs/bin/fillers/dot-filler.js"}],"node_modules/roughjs/bin/renderer.js":[function(require,module,exports) {
'use strict';
...
var _filler = require('./fillers/filler');
...
class RoughRenderer {
    ...
    svgPath(path, o) {
        ...
        let p = new _path.RoughPath(path);
        if (o.simplification) {
            const fitter = new _path.PathFitter(p.linearPoints, p.closed);
    ...
    patternFillPolygon(points, o) {
        const filler = (0, _filler.getFiller)(this, o);
            ...
            case 'q':
                {
                    ...
                    if (seg.data.length >= 4) {
                        ...
                        ops.push({
                            op: 'qcurveTo', data: [x1 + this.getOffset(-offset1, offset1, o), y1 + this.getOffset(-offset1, offset1, o), f[0], f[1]]
                        });
                        ...
                        ops.push({
                            op: 'qcurveTo', data: [x1 + this.getOffset(-offset2, offset2, o), y1 + this.getOffset(-offset2, offset2, o), f[0], f[1]]
                        });
                        path.setPosition(f[0], f[1]);
            ...
            case 'a':
                {
                    ...
                    if (seg.data.length >= 7) {
                        ...
                        if (rx === 0 || ry === 0) {
                            ...
                            for (let i = 0; i < 1; i++) {
                                const arcConverter = new _path.RoughArcConverter([path.x, path.y], [x, y], [rx, ry], angle, largeArcFlag ? true : false, sweepFlag ? true : false);
...
exports.RoughRenderer = RoughRenderer;
},{"./path.js":"node_modules/roughjs/bin/path.js","./fillers/filler":"node_modules/roughjs/bin/fillers/filler.js"}],"node_modules/roughjs/bin/renderer-factory.js":[function(require,module,exports) {
'use strict';
...
},{"./renderer":"node_modules/roughjs/bin/renderer.js"}],"node_modules/roughjs/bin/generator-base.js":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.RoughGeneratorBase = undefined;

var _rendererFactory = require('./renderer-factory.js');
...
class RoughGeneratorBase {
    constructor(config, surface) {
        ...
        this.renderer = (0, _rendererFactory.createRenderer)(this.config);
...
},{"./renderer-factory.js":"node_modules/roughjs/bin/renderer-factory.js"}],"node_modules/roughjs/bin/generator.js":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.RoughGenerator = undefined;

var _generatorBase = require('./generator-base');

class RoughGenerator extends _generatorBase.RoughGeneratorBase {
    constructor(config, surface) {
    ...
    polygon(points, options) {
        ...
        if (o.fill) {
            if (o.fillStyle === 'solid') {
                ...
                const fillPoints = [[0, 0], [size[0], 0], [size[0], size[1]], [0, size[1]]];
...
},{"./generator-base":"node_modules/roughjs/bin/generator-base.js"}],"node_modules/roughjs/bin/canvas-base.js":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.RoughCanvasBase = undefined;
...
},{"./renderer":"node_modules/roughjs/bin/renderer.js"}],"node_modules/roughjs/bin/canvas.js":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.RoughCanvas = undefined;

var _generator = require('./generator');

var _canvasBase = require('./canvas-base');

class RoughCanvas extends _canvasBase.RoughCanvasBase {
    constructor(canvas, config) {
        super(canvas);
        this.gen = new _generator.RoughGenerator(config || null, this.canvas);
    }
    get generator() {
        return this.gen;
    }
...
},{"./generator":"node_modules/roughjs/bin/generator.js","./canvas-base":"node_modules/roughjs/bin/canvas-base.js"}],"node_modules/roughjs/bin/generator-async.js":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.RoughGeneratorAsync = undefined;

var _generatorBase = require('./generator-base');

class RoughGeneratorAsync extends _generatorBase.RoughGeneratorBase {
...
exports.RoughGeneratorAsync = RoughGeneratorAsync;
},{"./generator-base":"node_modules/roughjs/bin/generator-base.js"}],"node_modules/roughjs/bin/canvas-async.js":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.RoughCanvasAsync = undefined;

var _generatorAsync = require('./generator-async');

var _canvasBase = require('./canvas-base');

class RoughCanvasAsync extends _canvasBase.RoughCanvasBase {
    constructor(canvas, config) {
        super(canvas);
        this.genAsync = new _generatorAsync.RoughGeneratorAsync(config || null, this.canvas);
    }
    get generator() {
...
exports.RoughCanvasAsync = RoughCanvasAsync;
},{"./generator-async":"node_modules/roughjs/bin/generator-async.js","./canvas-base":"node_modules/roughjs/bin/canvas-base.js"}],"node_modules/roughjs/bin/svg-base.js":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.RoughSVGBase = undefined;
...
},{"./renderer":"node_modules/roughjs/bin/renderer.js"}],"node_modules/roughjs/bin/svg.js":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.RoughSVG = undefined;

var _generator = require('./generator');

var _svgBase = require('./svg-base');

class RoughSVG extends _svgBase.RoughSVGBase {
    constructor(svg, config) {
        super(svg);
        this.gen = new _generator.RoughGenerator(config || null, this.svg);
    }
    get generator() {
        return this.gen;
    }
...
},{"./generator":"node_modules/roughjs/bin/generator.js","./svg-base":"node_modules/roughjs/bin/svg-base.js"}],"node_modules/roughjs/bin/svg-async.js":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.RoughSVGAsync = undefined;

var _generatorAsync = require('./generator-async');

var _svgBase = require('./svg-base');

class RoughSVGAsync extends _svgBase.RoughSVGBase {
    constructor(svg, config) {
        super(svg);
        this.genAsync = new _generatorAsync.RoughGeneratorAsync(config || null, this.svg);
    }
    get generator() {
        return this.genAsync;
    }
...
exports.RoughSVGAsync = RoughSVGAsync;
},{"./generator-async":"node_modules/roughjs/bin/generator-async.js","./svg-base":"node_modules/roughjs/bin/svg-base.js"}],"node_modules/roughjs/bin/rough.js":[function(require,module,exports) {
'use strict';
...
var _canvasAsync = require('./canvas-async');

var _svg = require('./svg');

var _svgAsync = require('./svg-async');

exports.default = {
    canvas(canvas, config) {
        if (config && config.async) {
            return new _canvasAsync.RoughCanvasAsync(canvas, config);
        }
        return new _canvas.RoughCanvas(canvas, config);
    },
    svg(svg, config) {
        if (config && config.async) {
            return new _svgAsync.RoughSVGAsync(svg, config);
        }
        return new _svg.RoughSVG(svg, config);
    },
    createRenderer() {
        return _canvas.RoughCanvas.createRenderer();
    },
    generator(config, surface) {
        if (config && config.async) {
            return new _generatorAsync.RoughGeneratorAsync(config, surface);
        }
        return new _generator.RoughGenerator(config, surface);
    }
};
},{"./canvas":"node_modules/roughjs/bin/canvas.js","./generator":"node_modules/roughjs/bin/generator.js","./generator-async":"node_modules/roughjs/bin/generator-async.js","./canvas-async":"node_modules/roughjs/bin/canvas-async.js","./svg":"node_modules/roughjs/bin/svg.js","./svg-async":"node_modules/roughjs/bin/svg-async.js"}],"js/application.js":[function(require,module,exports) {
'use strict';
...
window.saveSvg = function (svgEl, name) {
...
window.onload = function () {
  ...
  var firstDiagonal = new Path.Line({
    from: new Point(0, 0),
  ...
  var secondDiagonal = new Path.Line({
  ...
  var firstVertical = new Path.Line({
  ...
  var secondVertical = new Path.Line({
  ...
  var roughSVGElement = document.getElementById('svg');
  var roughSVG = _roughjs2.default.svg(roughSVGElement, { options: {
      stroke: 'white',
      strokeWidth: strokeWidth,
      roughness: 2.7,
      bowing: 2
  ...
  Array.from(project.exportSVG().querySelectorAll('path')).forEach(function (path) {
    roughSVGElement.appendChild(roughSVG.path(path.getAttribute('d')));
    roughSVGElement.appendChild(roughSVG.path(path.getAttribute('d')));
    roughSVGElement.appendChild(roughSVG.path(path.getAttribute('d')));
    roughSVGElement.appendChild(roughSVG.path(path.getAttribute('d')));
    roughSVGElement.appendChild(roughSVG.path(path.getAttribute('d')));
...
},{"paper":"node_modules/paper/dist/paper-full.js","roughjs":"node_modules/roughjs/bin/rough.js"}],"../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/application.057ee8fd.map